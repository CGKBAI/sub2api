...
func (_u *UserUpdate) SetReportPushEnabled(v bool) *UserUpdate {
	_u.mutation.SetReportPushEnabled(v)
	return _u
}

// SetNillableReportPushEnabled sets the "report_push_enabled" field if the given value is not nil.
func (_u *UserUpdate) SetNillableReportPushEnabled(v *bool) *UserUpdate {
	if v != nil {
		_u.SetReportPushEnabled(*v)
	}
	return _u
}

// SetReportGoal sets the "report_goal" field.
func (_u *UserUpdate) SetReportGoal(v string) *UserUpdate {
	_u.mutation.SetReportGoal(v)
	return _u
}

// SetNillableReportGoal sets the "report_goal" field if the given value is not nil.
func (_u *UserUpdate) SetNillableReportGoal(v *string) *UserUpdate {
	if v != nil {
		_u.SetReportGoal(*v)
	}
	return _u
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.ReportPushEnabled(); ok {
		_spec.SetField(user.FieldReportPushEnabled, field.TypeBool, value)
	}
	if value, ok := _u.mutation.ReportGoal(); ok {
...
// SetReportPushEnabled sets the "report_push_enabled" field.
func (_u *UserUpdateOne) SetReportPushEnabled(v bool) *UserUpdateOne {
	_u.mutation.SetReportPushEnabled(v)
	return _u
}

// SetNillableReportPushEnabled sets the "report_push_enabled" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableReportPushEnabled(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetReportPushEnabled(*v)
	}
	return _u
...
// SetReportGoal sets the "report_goal" field.
func (_u *UserUpdateOne) SetReportGoal(v string) *UserUpdateOne {
	_u.mutation.SetReportGoal(v)
	return _u
}

// SetNillableReportGoal sets the "report_goal" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableReportGoal(v *string) *UserUpdateOne {
	if v != nil {
		_u.SetReportGoal(*v)
	}
	return _u
