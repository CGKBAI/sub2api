...
var (
	...
	ReportsColumns = []*schema.Column{
		...
		{Name: "stats", Type: field.TypeJSON, SchemaType: map[string]string{"postgres": "jsonb"}},
	...
	UsersColumns = []*schema.Column{
		...
		{Name: "rpm_limit", Type: field.TypeInt, Default: 0},
		{Name: "report_push_enabled", Type: field.TypeBool, Default: false},
		{Name: "report_goal", Type: field.TypeString, Default: "", SchemaType: map[string]string{"postgres": "text"}},
	}
