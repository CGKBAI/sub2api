export default {
    ...
    users: {
      ...
      reportPushHint: 'Feishu auto-push for reports (scheduled generation only; manual push button is not affected)',
      reportPushOn: 'Feishu auto-push enabled for this user',
      reportPushOff: 'Feishu auto-push disabled for this user',
      failedToTogglePush: 'Failed to toggle Feishu push',
